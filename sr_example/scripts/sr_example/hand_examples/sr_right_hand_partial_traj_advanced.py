...
class PartialTrajListener:
    ...
    def __init__(self):
        ...
        rospy.Subscriber(
            ...
            FollowJointTrajectoryActionResult, callback_result)
        rospy.Subscriber(
...
def plot_settings(plot):
    ...
    plot.setp(axis.get_xticklabels(), fontsize=8)
    plot.setp(axis.get_yticklabels(), fontsize=8)
    plot.xlabel('Time (s)')
...
if __name__ == '__main__':
    ...
    trajectory_point_main = construct_trajectory_point(open_hand_current, 1.0)
    joint_trajectory.points.append(trajectory_point_main)
    ...
    joint_trajectory.points = []
    trajectory_point_main = construct_trajectory_point(grasp1_current, 1.0)
    joint_trajectory.points.append(trajectory_point_main)
    trajectory_point_main = construct_trajectory_point(grasp2_current, 4.0)
    joint_trajectory.points.append(trajectory_point_main)
    trajectory_point_main = construct_trajectory_point(grasp3_current, 6.0)
    joint_trajectory.points.append(trajectory_point_main)
    trajectory_point_main = construct_trajectory_point(grasp4_current, 8.0)
    joint_trajectory.points.append(trajectory_point_main)
    trajectory_point_main = construct_trajectory_point(grasp5_current, 10.0)
    joint_trajectory.points.append(trajectory_point_main)
    ...
    joint_trajectory.points = []
    trajectory_point_main = construct_trajectory_point(grasp_partial_1, 1.0)
    joint_trajectory.points.append(trajectory_point_main)
    trajectory_point_main = construct_trajectory_point(grasp_partial_2, 3.0)
    joint_trajectory.points.append(trajectory_point_main)
    hand_commander.run_joint_trajectory_unsafe(joint_trajectory, False)
