...
private:
   ...
   * @param A request message. See service definition for KinematicSolverInfo for more information on this message.
   * @param The response message. See service definition for KinematicSolverInfo for more
   *        information on this message.
   */
  bool getIKSolverInfo(moveit_msgs::KinematicSolverInfo::Request &request,
                       moveit_msgs::KinematicSolverInfo::Response &response);
   ...
   *        information on this message.
   */
  bool getFKSolverInfo(moveit_msgs::KinematicSolverInfo::Request &request,
                       moveit_msgs::KinematicSolverInfo::Response &response);
...
bool Kinematics::init()
{
  ...
  if (tip_name.find("fftip") == string::npos && tip_name.find("mftip") == string::npos &&
      tip_name.find("rftip") == string::npos && tip_name.find("lftip") == string::npos &&
      tip_name.find("thtip") == string::npos)
  {
  ...
  ROS_DEBUG("CHAIN--> Joints:%d, Ind. Joints:%d, Segments:%d", chain.getNrOfJoints(), chain.getNrOfIndJoints(),
  ...
  ik_solver_pos = new KDL::ChainIkSolverPos_NR_JL_coupling(chain, joint_min, joint_max, *fk_solver, *ik_solver_vel,
                               ...
                               moveit_msgs::GetPositionIK::Response &response)
{
  if ((request.ik_request.ik_link_name.find("fftip") == std::string::npos) &&
      ...
      (request.ik_request.ik_link_name.find("lftip") == std::string::npos) &&
      (request.ik_request.ik_link_name.find("thtip") == std::string::npos))
  {
  ...
  {
    if (request.ik_request.ik_link_name.find("thtip") != std::string::npos ||
        request.ik_request.ik_link_name.find("lftip") != std::string::npos)
...
bool Kinematics::getIKSolverInfo(moveit_msgs::KinematicSolverInfo::Request &request,
                                 moveit_msgs::KinematicSolverInfo::Response &response)
{
...
bool Kinematics::getFKSolverInfo(moveit_msgs::KinematicSolverInfo::Request &request,
                                 moveit_msgs::KinematicSolverInfo::Response &response)
{
  response.kinematic_solver_info = info;
  return true;
