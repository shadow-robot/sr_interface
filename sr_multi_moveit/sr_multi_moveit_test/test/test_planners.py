...
class TestPlanners(TestCase):
    ...
    def setUp(self):
        ...
        # self.msg.state.joint_state.name =  ['ra_shoulder_pan_joint',
        ...
        #                                     'rh_THJ2',
        #                                     'rh_THJ1']
        # self.msg.state.joint_state.position = [1.57542451065,
        #                                        3.01734161219,
        #                                        2.01043257686,
        #                                        -1.14647092839,
        #                                        0.694689321451,
...
# "+str(joints))
    ...
    def test_waypoints(self):
        ...
        (plan3, fraction) = self.group.compute_cartesian_path(
            waypoints, 0.01, 0.0)
        self.assertTrue(
            self._check_plan(plan3) and fraction > 0.8, msg="Unable to plan waypoints")
    ...
    def test_trajectories_with_walls_and_ground(self):
        ...
        joints = [
            ...
            0.0, 0.0]
        self.assertFalse(
            self._plan_joints(joints), msg="Able to plan to: " + str(joints))
