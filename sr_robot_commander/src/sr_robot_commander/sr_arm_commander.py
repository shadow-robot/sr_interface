...
class SrArmCommander(SrRobotCommander):
    ...
    def move_to_position_target(self, xyz, end_effector_link="", wait=True):
        ...
        """
        super(SrArmCommander, self).move_to_position_target(xyz, end_effector_link, wait=wait)
    ...
    def plan_to_position_target(self, xyz, end_effector_link=""):
        ...
        @param end_effector_link - name of the end effector link
        """
        super(SrArmCommander, self).plan_to_position_target(xyz, end_effector_link)
    ...
    def move_to_pose_target(self, pose, end_effector_link="", wait=True):
        ...
        @param wait - should method wait for movement end or not
        """
        super(SrArmCommander, self).move_to_pose_target(pose, end_effector_link, wait=wait)
    ...
    def plan_to_pose_target(self, pose, end_effector_link=""):
        ...
        @param end_effector_link - name of the end effector link
        """
        super(SrArmCommander, self).plan_to_pose_target(pose, end_effector_link)
