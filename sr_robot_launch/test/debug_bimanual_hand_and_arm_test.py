...
class TestBiHandAndArmSim(TestCase):
    ...
    def __init__(self):
        ...
        self.robot_commander = SrRobotCommander(name="two_arms_and_hands")
        self.hand_commander = SrHandCommander(name='two_hands')
        self.arm_commander = SrArmCommander(name='two_arms', set_ground=False)
...
if __name__ == "__main__":
    PKG = "sr_robot_launch"
    rospy.init_node("hand_and_arm_bimanual_test", anonymous=True)
    test = TestBiHandAndArmSim()
    rospy.sleep(5)
