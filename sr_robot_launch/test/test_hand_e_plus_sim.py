...
class TestHandEPlusSim(TestCase):
    """
    ...
    def setUp(self):
        rospy.init_node('test_hand_e_plus_sim', anonymous=True)
        rospy.wait_for_message('/move_group/status', GoalStatusArray)
        self.hand_commander = SrHandCommander(name='right_hand')

    def test_hand_e_plus_sim(self):
...
if __name__ == "__main__":
    rostest.rosrun(PKG, "test_handEPlusSim", TestHandEPlusSim)
