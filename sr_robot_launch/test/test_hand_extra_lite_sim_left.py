...
class TestHandExtraLiteSimLeft(TestCase):
    """
    ...
    def setUp(self):
        rospy.init_node('test_hand_extra_lite_sim_left', anonymous=True)
...
if __name__ == "__main__":
    rostest.rosrun(PKG, "test_handExtraLiteSimLeft", TestHandExtraLiteSimLeft)
