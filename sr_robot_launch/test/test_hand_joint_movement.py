...
class TestHandJointMovement(TestCase):
    ...
    @classmethod
    def setUpClass(cls):
        cls.hand_type = rospy.get_param('/test_hand_joint_movement/test_sim/hand_type', "hand_e_plus")
        ...
        cls.hand_id = rospy.get_param('/test_hand_joint_movement/test_sim/hand_id', "rh")
