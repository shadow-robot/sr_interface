...
class TestHandAndArmSim(TestCase):
    ...
    def test_11_arms(self):
        ...
        arm_joints_target = dict(la_arm_joints_target.items() | ra_arm_joints_target.items())
    ...
    def test_12_hand_and_arm(self):
        ...
        arm_joints_target = dict(ra_arm_joints_target.items() | la_arm_joints_target.items())
